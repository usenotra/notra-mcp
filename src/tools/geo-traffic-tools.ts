...
export function registerGeoTrafficTools(server: McpServer, client: NotraClient) {
  ...
  server.registerTool(
    "list_geo_traffic_journeys",
    {
      ...
      annotations: {
        title: "List AI Traffic Journeys",
        readOnlyHint: true,
        openWorldHint: false,
        destructiveHint: false,
      },
  ...
  server.registerTool(
    "get_geo_ingest_setup",
    {
      ...
      annotations: {
        title: "Get AI Traffic Ingest Setup",
        readOnlyHint: true,
        openWorldHint: false,
        destructiveHint: false,
      },
  ...
  server.registerTool(
    "issue_geo_ingest_token",
    {
      ...
      annotations: {
        title: "Issue AI Traffic Ingest Token",
        readOnlyHint: false,
        openWorldHint: false,
        destructiveHint: false,
      },
  ...
  server.registerTool(
    "rotate_geo_ingest_token",
    {
      ...
      annotations: {
        title: "Rotate AI Traffic Ingest Token",
        readOnlyHint: false,
        openWorldHint: false,
